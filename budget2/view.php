...
<body>
    ...
    <div class="container">
        ...
        <p><strong>S. No:</strong> <?php echo $row['SNo']; ?></p>
            ...
            <p><strong>Management Comments:</strong> <?php echo $row['additional_commant']; ?></p>
</div>
<center><button style="background-color:blue"><a href="admin.php" style="color:white;text-decoration:none"><b>Ok</b></a></button>    </center>        
