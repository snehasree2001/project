...
<body>
    ...
    <div class="container">
        ...
        <p><strong>S. No:</strong> <?php echo $row['SNo']; ?></p>
            ...
            <p><strong>Faculty Name:</strong> <?php echo $row['student_name']; ?></p>
...
<center><button style="background-color:blue"><a href="student_admin.php" style="color:white;text-decoration:none"><b>Ok</b></a></button>    </center>        
