...
$query_view_details = "SELECT * FROM students";
...
$query_status_details = "SELECT * FROM student WHERE status='$status'";
        ...
        <div class="container">
            <table border="1" style="font-size:4px;margin-left:35px">
                ...
                while ($row = mysqli_fetch_assoc($result_status_details)) {
                    ...
                    echo "<td>";
                    if ($status == 'approved') {
                        echo "<a href='student_view.php?SNo=" . $row['SNo'] . "'><button>View</button></a>";
                    } 
                    elseif ($status == 'disapproved') {
                        echo "<a href='student_view.php?SNo=" . $row['SNo'] . "'><button>View</button></a>";
                    } else {
                        echo "<a href='student_pending.php?SNo=" . $row['SNo'] . "'><button>Pending</button></a>";
                    }
                    echo "</td>";
                    echo "</tr>";
                }
